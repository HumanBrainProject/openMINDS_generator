...
def main(schema_path, generator_path=None, ignore=[], build_docs=False):
    ...
    from commons import TARGET_PATH, OPENMINDS_VOCAB
    from expander import Expander
    from vocab_extractor import VocabExtractor
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        prog=sys.argv[0], 
        description='Generate classes from the EBRAINS openMINDS schema templates'
    )
