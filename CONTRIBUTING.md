...
You can also report and ask questions through the issue tracker of this GitHub repository. However, if your concern is of general nature or affecting one of the openMINDS metadata model repositories, please consider raising an issue on the central openMINDS repository or the affected repository instead.
...
If you want to contribute to the openMINDS_generator repository directly, feel free to fork it and open pull requests with your changes. Note, that larger changes and new features should be first raised and discussed as an issue before making a pull request. Minor bug fixes can, of course, still be made directly as a pull request without raising an issue first. Direct contributions to one of the openMINDS metadata models, the openMINDS generator or openMINDS (central) should be made on the respective GitHub repository.
